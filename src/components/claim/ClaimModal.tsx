        ...
        <ContentWrapper gap="lg">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              <Trans>
                As a member of the Teleswap community you may claim TELE to be used for voting and governance.
                <br />
                <br />
                <ExternalLink href="https://telefy.finance">Read more about TELE</ExternalLink>
              </Trans>
            </TYPE.subHeader>
            <ButtonPrimary
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <UniTokenAnimated width="72px" src={tokenLogo} alt="TELE" />
            )}
          </ConfirmedIcon>
