...
import { Currency, CurrencyAmount, Fraction, Percent, TradeType } from '@telefy/teleswap-core-sdk'
...
const THIRTY_BIPS_FEE = new Percent(JSBI.BigInt(27), JSBI.BigInt(10000))
