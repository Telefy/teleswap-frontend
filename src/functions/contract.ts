...
import { ChainId, ROUTER_ADDRESS } from '@telefy/teleswap-core-sdk'
import IUniswapV2Router02ABI from 'abis/uniswap-v2-router-02.json'
import IUniswapV2Router02NoETHABI from 'abis/uniswap-v2-router-02-no-eth.json'
