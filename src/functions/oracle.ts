...
import { ChainId, CHAINLINK_ORACLE_ADDRESS } from '@telefy/teleswap-core-sdk'
import { CHAINLINK_PRICE_FEED_MAP } from 'config/oracles/chainlink'
import { ChainlinkOracle, Oracle } from 'features/kashi/oracles'

import { e10 } from './math'

// @ts-ignore TYPE NEEDS FIXING
export function getOracle(chainId: ChainId = ChainId.MAINNET, address: string, data: string): Oracle {
...
// @ts-ignore TYPE NEEDS FIXING
export function validateChainlinkOracleData(chainId = ChainId.MAINNET, collateral: Token, asset: Token, data: string) {
