...
import { Currency, CurrencyAmount, Fraction, Percent, Token, TradeType } from '@telefy/teleswap-core-sdk'
import { Trade } from '@mazelon/teleswap-sdk'
import JSBI from 'jsbi'

const ONE_HUNDRED_PERCENT = new Percent('100'),
