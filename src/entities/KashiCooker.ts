...
import { BENTOBOX_ADDRESS, ChainId, WNATIVE } from '@telefy/teleswap-core-sdk'
import KASHIPAIR_ABI from 'abis/kashipair.json'
import KashiMediumRiskLendingPair from 'features/kashi/KashiMediumRiskLendingPair'
...
export default class KashiCooker {
  ...
  addAsset(amount: BigNumber, fromBento: boolean, burnShare = false): KashiCooker {
    let share: BigNumber
    if (fromBento) {
