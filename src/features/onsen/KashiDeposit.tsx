...
import { BENTOBOX_ADDRESS, KASHI_ADDRESS, WNATIVE_ADDRESS } from '@telefy/teleswap-core-sdk'
...
import { tryParseAmountUni } from 'functions/parse-uni'
...
const KashiDeposit = ({ market, header }: { market: KashiMediumRiskLendingPair; header: JSX.Element }) => {
  ...
  const parsedDepositValue = tryParseAmountUni(depositValue, asset)
