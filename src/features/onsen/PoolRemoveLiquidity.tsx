...
import ListPanel from 'farm-components/ListPanel'
...
import PoolRemoveLiquidityReviewContent from 'features/onsen/PoolRemoveLiquidityReviewContent'
import { calculateGasMargin, calculateSlippageAmount } from 'functions'
import { ApprovalState, useApproveCallback } from 'hooks/useApproveCallback'
import { usePairContract, useV2RouterContract as useRouterContract } from 'hooks/useContract'
...
const USER_REJECTED_TX = 4001,
  DEFAULT_REMOVE_LIQUIDITY_SLIPPAGE_TOLERANCE = new Percent(5, 100),
  ZERO = JSBI.BigInt(0)
