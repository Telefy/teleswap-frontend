...
export const AGEUR = new Token(ChainId.MAINNET, '0x1a7e4e63778B4f12a199C062f3eFdD288afCBce8', 18, 'agEUR', 'agEUR')
export const ANGLE = new Token(ChainId.MAINNET, '0x31429d1856aD1377A8A0079410B297e1a9e214c2', 18, 'ANGLE', 'ANGLE')
export const STG = new Token(ChainId.MAINNET, '0xAf5191B0De278C7286d6C7CC6ab6BB8A73bA2Cd6', 18, 'STG', 'StargateToken')
