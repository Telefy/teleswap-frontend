...
import { PoolType } from '@telefy/teleswap-trident-sdk'
import { fetcher, TridentPoolData } from 'services/graph'
import { getTridentPositionsQuery } from 'services/graph/queries'
