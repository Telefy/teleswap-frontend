...
import CloseIcon from 'farm-components/CloseIcon'
import HeadlessUiModal from 'farm-components/Modal/HeadlessUIModal'
import Popover from 'farm-components/Popover'
import QuestionHelper from 'farm-components/QuestionHelper'
import Switch from 'farm-components/Switch'
import TransactionSettings from 'farm-components/TransactionSettings'
import Typography from 'farm-components/Typography'
import { Feature } from 'enums'
import { classNames, featureEnabled } from 'functions'
import useWalletSupportsSushiGuard from 'hooks/useWalletSupportsSushiGuard'
import { useActiveWeb3React } from 'hooks/web3'
import { useToggleSettingsMenu } from 'state/application/hooks'
import { useExpertModeManager, useUserSingleHopOnly, useUserSushiGuard } from 'state/user/hooks'
  ...
  return (
    <>
      <Popover
        ...
        content={
          <div className="flex flex-col gap-3 p-3 border rounded shadow-xl bg-theme w-80 border-dark-700">
      ...
      >
        ...
        >
          <CogIcon className="w-[26px] h-[26px] transform rotate-90 text-white hover:text-white" />
        </div>
      </Popover>
