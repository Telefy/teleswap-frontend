...
import ModalActions, { ModalActionsProps } from 'farm-components/Modal/Actions'
import ModalBody, { ModalBodyProps } from 'farm-components/Modal/Body'
import ModalContent, {
  BorderedModalContent,
  ModalContentBorderedProps,
  ModalContentProps,
} from 'farm-components/Modal/Content'
import ModalError, { ModalActionErrorProps } from 'farm-components/Modal/Error'
import ModalHeader, { ModalHeaderProps } from 'farm-components/Modal/Header'
import SubmittedModalContent, { SubmittedModalContentProps } from 'farm-components/Modal/SubmittedModalContent'
